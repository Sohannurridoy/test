...
a=requests.get("https://raw.githubusercontent.com/Sohannurridoy/f-7/main/Approval.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('https://www.facebook.com/fb.real.hacker')
    exit()
